...
function exit_handler() {
    ...
    aws --region us-west-1 cloudformation delete-stack --stack-name "$stack_id"

    echo ""
    echo "Polling till the stack deletion completes..."
    aws --region us-west-1 cloudformation wait stack-delete-complete --stack-name "$stack_id"
